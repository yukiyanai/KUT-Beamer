...
## Installation
##########################################################################
1. Download the whole direcotry by clicking Download ZIP button on the right of the GitHub page.
...
3. Once you put the KUT-Beamer folder in the appropriate directory, type in the terminal:
  sudo mktexlsr
...
Please use "nologo" option if you have not obtained the logo files yourself from the KUT's official website <http://www.kochi-tech.ac.jp/kut_J/gakunai/internal/logomark.html>, which you cannot access from outside the university (see KUT Logo section below).
...
This color theme mainly uses green and blue, which are KUT's school colors, and is distributed as beamercolorthemekochi.sty.
...
This color theme mainly uses black and gray and is distributed as beamercolorthemetosayamada.sty.
...
You must either obtain the logos from the official website of the university (internal access only) or use "nologo" option (see Usage section above).

#### Getting the logos

To obtain the logos, you need to connect to KUT's network system. You can connect to the University's network on campus.

1. Go to http://www.kochi-tech.ac.jp/kut_J/gakunai/internal/logomark.html in KUT's official website.
2. Read the rules <http://www.kochi-tech.ac.jp/kut_J/gakunai/internal/image/youkou.pdf> and the guideline <http://www.kochi-tech.ac.jp/kut_J/gakunai/internal/image/KUT_rogoguideline_201603.pdf> about the university's logo marks.
3. Download three logos
	(1). 2016_logo05.jpg
	(2). 2016_logo07.jpg
	(3). 2016_logo09.jpg
4. Save downloaded logo files in the logo folder inside KUT-Beamer folder.
